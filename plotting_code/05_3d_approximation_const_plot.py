...
####################################
DATA_DIR = '../results/model_outputs/05_3d_approximation_const/'
SAVE_DIR = '../results/plots/05_3d_approximation_performance_const/'
...
const = torch.squeeze(list_2_tensor(results['const']))
