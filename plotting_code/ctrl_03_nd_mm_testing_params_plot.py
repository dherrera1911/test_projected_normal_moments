...
saveFig = True
plotDir = '../../plots/control/03_nd_mm_testing_params/'
...
# Load numpy data
dataDir = '../../results/controls/03_nd_mm_training_test_params/'
covType = 'uncorrelated'
nDim = 25
gammaTrue = np.load(dataDir + f'gammaTrue_{covType}_{nDim}.npy')
gammaFit = np.load(dataDir + f'gammaFit_{covType}_{nDim}.npy')
gammaOracle = np.load(dataDir + f'gammaOracle_{covType}_{nDim}.npy')
psiTrue = np.load(dataDir + f'psiTrue_{covType}_{nDim}.npy')
psiFit = np.load(dataDir + f'psiFit_{covType}_{nDim}.npy')
psiOracle = np.load(dataDir + f'psiOracle_{covType}_{nDim}.npy')
muTrue = np.load(dataDir + f'muTrue_{covType}_{nDim}.npy')
muFit = np.load(dataDir + f'muFit_{covType}_{nDim}.npy')
muOracle = np.load(dataDir + f'muOracle_{covType}_{nDim}.npy')
covTrue = np.load(dataDir + f'covTrue_{covType}_{nDim}.npy')
covFit = np.load(dataDir + f'covFit_{covType}_{nDim}.npy')
covOracle = np.load(dataDir + f'covOracle_{covType}_{nDim}.npy')
lossFit = np.load(dataDir + f'lossFit_{covType}_{nDim}.npy')
lossOracle = np.load(dataDir + f'lossOracle_{covType}_{nDim}.npy')
...
############################
# 3) PLOT LOSS TRAINING DYNAMICS
############################

# Plot the training dynamics
plt.figure(figsize=(12, 4))

plt.plot(lossFit[0,0,:])
