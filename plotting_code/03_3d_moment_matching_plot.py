...
DATA_DIR = '../results/model_outputs/03_3d_moment_matching/'
SAVE_DIR = '../results/plots/03_3d_moment_matching/'
...
error_label = [r'$\mathrm{Error}_{\mu}$ (%)', r'$\mathrm{Error}_{\Sigma}$ (%)']
