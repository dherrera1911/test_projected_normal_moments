...
####################################
DATA_DIR = '../results/model_outputs/06_nd_approximation_const/'
SAVE_DIR = '../results/plots/06_nd_approximation_performance_const/'
...
for n_dim in n_dim_list:
    ...
    const.append(
      torch.squeeze(list_2_tensor(results['const']))
    )
