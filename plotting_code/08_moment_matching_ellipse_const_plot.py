...
####################################
DATA_DIR = '../results/model_outputs/08_moment_matching_ellipse_const'
SAVE_DIR = '../results/plots/08_moment_matching_ellipse_const/'
...
plt.savefig(SAVE_DIR + f'05_const.pdf', bbox_inches='tight')
plt.close()
